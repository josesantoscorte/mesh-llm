...
impl MoeConfig {
    fn from_json(raw: MoeConfigJson) -> Self {
        Self {
            ...
            ranking: ranking_for_key(raw.ranking_key.as_deref()),
        }
    }
}

fn ranking_for_key(key: Option<&str>) -> Vec<u32> {
    match key {
        Some("QWEN3_30B_A3B_RANKING") => QWEN3_30B_A3B_RANKING.to_vec(),
        Some(other) => panic!("unknown bundled ranking key: {other}"),
        None => Vec::new(),
    }
}
